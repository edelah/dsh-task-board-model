...
var AppServerClient = class {
	...
	*/
	async dispose() {
		if (this.handle === void 0 || this.exited) {
...
*/
function taskBoardRouteHandlers(subprocess) {
...
*/
function registerTaskBoardRoutes(webServer, subprocess) {
	return [...taskBoardRouteHandlers(subprocess).entries()].map(([path, handle]) => webServer.register({
		kind: "exact",
		path,
