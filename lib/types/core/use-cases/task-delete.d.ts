 ...
 */
export declare function applyDeleteTask(tasks: readonly TaskRecord[], selectedTaskId: string | undefined, id: string): DeleteTaskResult;
//# sourceMappingURL=task-delete.d.ts.map